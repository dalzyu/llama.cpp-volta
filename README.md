...
> [!NOTE]
> This branch contains experimental CUDA optimizations for NVIDIA Volta
> (`sm_70`). See the [Volta branch notes](VOLTA.md) for scope, implementation
> links, validation records, and benchmark documentation.
